...
allHrs.forEach((num)=>num.style.background= "antiquewhite")

// Change the 'border-radius' of all the hr to "5px" using array.

allHrs.forEach((num)=>num.style.borderRadius= "5px")
...
allHrs.forEach((num)=>num.style.border= "dashed")
